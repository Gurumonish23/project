...
class Univdetail(models.Model):
    ...
    Campuses=models.CharField(max_length=500,null=True)
    Departments = models.CharField(max_length=500,null=True)
...
class Univcon(models.Model):
    Email=models.EmailField()
    Intakes=models.CharField(max_length=500,null=True)
    Award=models.CharField(max_length=500,null=True)
    Staff=models.CharField(max_length=500,null=True)
    Students=models.CharField(max_length=500,null=True)
    Departments=models.CharField(max_length=500,null=True)
    Location=models.CharField(max_length=500,null=True)

    Link=models.CharField(max_length=500,null=True)
    Face=models.CharField(max_length=500,null=True)
    Insta=models.CharField(max_length=500,null=True)
